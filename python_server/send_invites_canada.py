...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('./out_sent_invites/log/wedding_invites.log'),
...
def main():
    ...
    try:
        ...
        output_path = f'./out_sent_invites/sent_invites_{datetime.now().strftime("%Y%m%d_%H%M%S")}.csv'
